...
//                     ref={menuTrigger}
//                     onClick={() => setOpen(!open)}
//                     className="inline-flex items-center justify-between whitespace-nowrap rounded-[5px] bg-primary py-[9px] pl-4 pr-[18px] text-base font-medium text-white hover:bg-opacity-90"
//                 >
...
//                 <div
//                     ref={menuRef}
//                     className={`absolute left-0 top-[115%] z-10 w-[180px] rounded-lg border-[.5px] border-stroke bg-white py-4 transition-all dark:border-dark-3 dark:bg-dark-2 ${!open && "hidden"
//                         } `}
//                 >
//                     <span className="absolute -top-[6px] left-6 -z-10 hidden h-3 w-3 rotate-45 rounded-sm border-[.5px] border-b-0 border-r-0 border-stroke bg-white dark:border-dark-3 dark:bg-dark-2 lg:block"></span>
//                     {children}
//                 </div>
//             </div>
//         </div>
...
//                     </a>
//                     <div
//                         className={`left-full top-0 border-stroke bg-white py-2 group-hover:visible group-hover:opacity-100 dark:border-dark-3 dark:bg-dark-2 lg:invisible lg:absolute lg:w-[600px] lg:rounded lg:border-[.5px] lg:px-8 lg:py-8 lg:opacity-0 xl:w-[650px]`}
//                     >
...
//                                         <img
//                                             src="https://cdn.tailgrids.com/assets/images/e-commerce/navbars/navbar-02/bannder.jpg"
//                                             alt="banner"
