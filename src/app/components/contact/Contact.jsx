        ...
        <>
                                ...
                                <div className="min-h-[500px] flex items-center justify-center">
                                    {status === "success" ? (
                                        <div className="flex flex-col items-center justify-center">
                                            <div className="text-3xl font-semibold text-green-600 mb-4">Thank you!</div>
                                            <div className="text-lg text-body-color dark:text-dark-6 text-center">
            ...
            <div className="w-full mt-12">
                <iframe
                    ...
                    src="https://maps.google.com/maps?q=53.695246,-2.631758&z=15&output=embed"
                    allowFullScreen
                    loading="lazy"
                ></iframe>
            </div>
