                    ...
                    <Swiper slidesPerView={1} ref={sliderRef}>
                        <SwiperSlide>
                            <SingleTestimonial
                                ...
                                reviewAlt="lineicon"
                                details="a review - Velit est sit voluptas eum sapiente omnis! Porro, impedit minus quam reprehenderit tempore sint quaerat id! Mollitia perspiciatis est asperiores commodi labore!"
                                name="Larry Diamond"
